...
#     .withColumn("created_at", date_format("created_at", "yyyy-MM-dd HH:mm:ss")) # 2022-12-31 11:29:00
...
customer_unified_key = df_drop.withColumn("customer_unified_key",col("phone"))
datekey =  customer_unified_key.withColumn('datekey', date_format(col('created_at'), 'yyyyMMdd'))

# # datekey.write.format('delta').mode("overwrite").save("s3a://cdp-trigger-data-model/delta/miley/customer_profile/")
...
#     connection_type="s3",
#     format="csv",
#     connection_options={"path": "s3://tientest/data_output/csv/shopee_v1.csv", "partitionKeys": []},
